...
export default function CustomerRegistration({ auth }: PageProps) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">CustomerRegistration</h2>}
        >
            <Head title="CustomerRegistration" />
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="max-w-sm mx-auto">
                            ...
                            <div className="mb-5">
                                <label htmlFor="street_or_avenue"
                                    className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Street or Avenue</label>
                                <input
                                    type="text"
                                    id="street_or_avenue"
                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
